    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}  className="max-w-sm mx-auto mt-10">
            <div className="mb-5">
                ...
                <input {...register("email")}  type="text" id="email" className="bg-gray-50 border border-gray-300  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div className="mb-8">
                ...
                <input {...register("password")} type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
                <button type="submit" className="text-white cursor-pointer bg-blue-accent-500 hover:bg-blue-900 font-medium rounded-lg text-sm w-full  px-5 py-2.5 text-center">
